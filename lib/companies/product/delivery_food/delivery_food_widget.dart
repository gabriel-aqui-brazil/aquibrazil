                                    ...
                                    Padding(
                                      ...
                                      child: Text(
                                        FFLocalizations.of(context).getText(
                                          'n4zbki52' /* OFERTAS IMPERDÍVEIS! APROVEITE... */,
                                        ),
                                                            ...
                                                            Padding(
                                                              ...
                                                              child: Text(
                                                                FFLocalizations.of(
                                                                        context)
                                                                    .getText(
                                                                  'pcmf5gv5' /* COM AQUIPASS VOCÊ ECONOMIZA */,
                                                                ),
                                ...
                                child: Builder(
                                  builder: (context) {
                                    ...
                                    return ListView.separated(
                                      ...
                                      itemBuilder:
                                          (context, sessionProductIndex) {
                                        final sessionProductItem =
                                            sessionProduct[sessionProductIndex];
                                        return Column(
                                          mainAxisSize: MainAxisSize.max,
                                          crossAxisAlignment:
                                                                  ...
                                                                  Flexible(
                                                                    child:
                                                                      ...
                                                                      children:
                                                                        ...
                                                                        Text(
                                                                          functions
                                                                              .toUpperCase(productsListItem.name),
                                                                          style: FlutterFlowTheme.of(context)
                                                                              .bodyMedium
                                                                              .override(
                                                                                font: GoogleFonts.poppins(
                                                                        ...
                                                                        if (productsListItem.description !=
                                                                                null &&
                                                                            productsListItem.description !=
                                                                                '')
                                                                          Text(
                                                                        ...
                                                                        if (!aquibrazil_library_oi8i5r_data_schema.SessionProductStruct.maybeFromMap(deliveryFoodQuerySessionProductsDeliveryResponse.jsonBody)!
                                                                            .customer
                                                                            .membership
                                                                            .hasId())
                                                                          Row(
                                                                                ...
                                                                                child: RichText(
                                                                                  ...
                                                                                  text: TextSpan(
                                                                                    children: [
                                                                                      TextSpan(
                                                                                        text: FFLocalizations.of(context).getText(
                                                                                          'y3442gxi' /* COM A AQUIPASS VOCÊ ECONOMIZA  */,
                                                                                        ),
                                                                                        style: FlutterFlowTheme.of(context).bodyMedium.override(
                                                                                              font: GoogleFonts.inter(
                                                                                                fontWeight: FontWeight.normal,
                                                                  ...
                                                                  Container(
                                                                    ...
                                                                    child:
                                                                      ...
                                                                      children: [
                                                                        ...
                                                                        if (productsListItem.individualDiscount !=
                                                                            0.0)
                                                                          Align(
                                                                            alignment:
