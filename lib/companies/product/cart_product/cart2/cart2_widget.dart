...
class Cart2Widget extends StatefulWidget {
  ...
  static String routeName = 'cart2';
  static String routePath = 'cart2';

  @override
  State<Cart2Widget> createState() => _Cart2WidgetState();
}
                ...
                child: Container(
                  ...
                  child: Padding(
                    ...
                    child: Column(
                      ...
                      children: [
                        if ((FFAppState().cart.company.deliveryType ==
                                'Retirada') ||
                            (FFAppState().cart.company.deliveryType == 'Ambos'))
                          Padding(
                              ...
                              children: [
                                ...
                                Container(
                                  decoration: BoxDecoration(
                                    ...
                                    border: Border.all(
                                      color:
                                          FlutterFlowTheme.of(context).cinzaE6,
                                    ),
                                  ),
                                  child: Padding(
                                    padding: EdgeInsets.all(16.0),
                                                          ...
                                                          functions.toUpperCase(
                                                            ...
                                                            DateTime
                                                                .fromMillisecondsSinceEpoch(
                                                                    valueOrDefault<
                                                                        int>(
                                                              FFAppState().preferredTimeDelivery !=
                                                                      null
                                                                  ? FFAppState()
