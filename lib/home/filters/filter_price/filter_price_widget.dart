...
import 'filter_price_model.dart';
export 'filter_price_model.dart';
...
class _FilterPriceWidgetState extends State<FilterPriceWidget> {
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => FilterPriceModel());
  }
