...
import 'dart:ui';
import '/index.dart';
import 'confirm_phone_widget.dart' show ConfirmPhoneWidget;
...
class ConfirmPhoneModel extends FlutterFlowModel<ConfirmPhoneWidget> {
  ...
  // Stores action output result for [Backend Call - API (Edit profile validate code sms)] action in PinCode widget.
  ApiCallResponse? validateSMS;
  // Stores action output result for [Backend Call - API (Edit profile validate code whatsapp)] action in PinCode widget.
