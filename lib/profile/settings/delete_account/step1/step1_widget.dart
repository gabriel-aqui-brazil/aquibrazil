                      ...
                      children: [
                        ...
                        Column(
                          ...
                          children: [
                            Text(
                              FFLocalizations.of(context).getText(
                                'e1l7nfkg' /* CONFIRA OS DADOS DA SUA CONTA */,
                              ),
                              style: FlutterFlowTheme.of(context)
                                  .bodyMedium
                                  .override(
                            ...
                            Text(
                              FFLocalizations.of(context).getText(
                                'l0jovwxu' /* Verifique os dados da sua cont... */,
                              ),
                              style: FlutterFlowTheme.of(context)
                                  .bodyMedium
                                  .override(
                              ...
                              children: [
                                    ...
                                    Flexible(
                                      child: Column(
                                        ...
                                        children: [
                                          ...
                                          Text(
                                            FFLocalizations.of(context).getText(
                                              '20itc1bo' /* Fale com nosso time se tiver a... */,
                                            ),
                                            style: FlutterFlowTheme.of(context)
                                                .bodyMedium
                                                .override(
                                ...
                                FFButtonWidget(
                                  ...
                                  text: FFLocalizations.of(context).getText(
                                    'awy95s0w' /* FALAR COM A AQUIBRAZIL */,
                                  ),
                                  icon: Icon(
