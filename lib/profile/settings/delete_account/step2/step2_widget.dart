                      ...
                      children: [
                        ...
                        Column(
                          ...
                          children: [
                            Text(
                              FFLocalizations.of(context).getText(
                                'py4nkns5' /* O QUE VOCÊ PRECISA SABER */,
                              ),
                              style: FlutterFlowTheme.of(context)
                                  .bodyMedium
                                  .override(
                            ...
                            Text(
                              FFLocalizations.of(context).getText(
                                '25n93u0x' /* Ao encerrar sua conta você vai... */,
                              ),
                              style: FlutterFlowTheme.of(context)
                                  .bodyMedium
                                  .override(
                          ...
                          child: Padding(
                            ...
                            child: Column(
                              ...
                              children: [
                                Text(
                                  FFLocalizations.of(context).getText(
                                    'vf7rtv6g' /* * ACESSO À CONFIGURAÇÕES DE CO... */,
                                  ),
                                  style: FlutterFlowTheme.of(context)
                                      .bodyMedium
                                      .override(
                                ...
                                Text(
                                  FFLocalizations.of(context).getText(
                                    '7jarq87m' /* *SEU CASHBACK DISPONÍVEL */,
                                  ),
                                  style: FlutterFlowTheme.of(context)
                                      .bodyMedium
                                      .override(
                                ...
                                Text(
                                  FFLocalizations.of(context).getText(
                                    '26dsk9go' /* *SEUS FAVORITOS E HISTÓRICO DE... */,
                                  ),
                                  style: FlutterFlowTheme.of(context)
                                      .bodyMedium
                                      .override(
                                    ...
                                    Flexible(
                                      child: Column(
                                        ...
                                        children: [
                                          ...
                                          Text(
                                            FFLocalizations.of(context).getText(
                                              'dfid3rn8' /* SE VOCÊ PEDIU UMA CÓPIA DOS SE... */,
                                            ),
                                            style: FlutterFlowTheme.of(context)
                                                .bodyMedium
                                                .override(
                        ...
                        Material(
                          ...
                          child: Theme(
                            ...
                            child: CheckboxListTile(
                              ...
                              subtitle: Text(
                                FFLocalizations.of(context).getText(
                                  'xvdw8fbl' /* Entendo que, ao encerrar minha... */,
                                ),
                                style: FlutterFlowTheme.of(context)
                                    .labelMedium
                                    .override(
                            ...
                            Expanded(
                              child: FFButtonWidget(
                                onPressed: !_model.checkboxListTileValue!
                                    ? null
                                    : () async {
                                        _model.apiResultbor = await MainGroup
                                            .getCodeDeleteAccountCall
                                            .call(
                                          token: currentAuthenticationToken,
                                        );

                                        if ((_model.apiResultbor?.succeeded ??
                                            true)) {
                                          context
                                              .pushNamed(Step3Widget.routeName);
                                        }
                                ...
                                options: FFButtonOptions(
                                  ...
                                  borderRadius: BorderRadius.circular(12.0),
                                  disabledColor: Color(0x80F27182),
                                ),
                              ),
                            ),
