...
class Step3Model extends FlutterFlowModel<Step3Widget> {
  ...
  // Stores action output result for [Backend Call - API (Validate code delete account)] action in Button widget.
  ApiCallResponse? apiResulthi0;
  // Stores action output result for [Backend Call - API (Delete account)] action in Button widget.
  ApiCallResponse? apiResultl4i;
