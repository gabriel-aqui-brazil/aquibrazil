                              ...
                              Text(
                                valueOrDefault<String>(
                                  '${valueOrDefault<String>(
                                    ...
                                    functions
                                        .toUpperCase(currentUserData?.lastName),
                                    '--',
                                  )}',
                                  '--',
                                ),
                                      ...
                                      if (false)
                                        InkWell(
                                          ...
                                          onTap: () async {
                                            ...
                                            _model.apiResultl1c =
                                                await MainGroup.gETChatExistCall
                                                    .call(
                                            ...
                                            if ((_model
                                                    .apiResultl1c?.succeeded ??
                                                true)) {
                                              context.pushNamed(
                                                ChatWidget.routeName,
                                                queryParameters: {
                                                  'chatId': serializeParam(
                                                    MainGroup.gETChatExistCall
                                                        .chatid(
                                                      (_model.apiResultl1c
                                                              ?.jsonBody ??
                                                          ''),
                                                    ...
                                                    Padding(
                                                      ...
                                                      child: Text(
                                                        FFLocalizations.of(
                                                                context)
                                                            .getText(
                                                          'me624ak8' /* MEUS MÉTODOS DE PAGAMENTO */,
                                                        ),
                                                        style: FlutterFlowTheme
                                                                .of(context)
                                                            .bodyMedium
                                  ...
                                  child: Column(
                                    ...
                                    children: [
                                      ...
                                      InkWell(
                                        ...
                                        onTap: () async {
                                          context
                                              .pushNamed(Step1Widget.routeName);
                                        },
                                        child: AnimatedContainer(
                                          duration: Duration(milliseconds: 150),
                                          curve: Curves.easeInOut,
                                  ...
                                  child: Column(
                                    ...
                                    children: [
                                      InkWell(
                                        ...
                                        onTap: () async {
                                          await launchURL(
                                              'https://www.instagram.com/aquibrazil');
                                        },
                                        child: AnimatedContainer(
                                          duration: Duration(milliseconds: 150),
                                          curve: Curves.easeInOut,
