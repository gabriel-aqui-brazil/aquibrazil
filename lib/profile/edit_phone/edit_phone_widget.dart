...
class EditPhoneWidget extends StatefulWidget {
  ...
  static String routeName = 'editPhone';
  static String routePath = 'editPhone';
                          ...
                          children: [
                            Expanded(
                              child: Align(
                                ...
                                child: Text(
                                  FFLocalizations.of(context).getText(
                                    'ucd5a7uk' /* DIGITE O SEU NÚMERO DE TELEFON... */,
                                  ),
                            ...
                            Align(
                              ...
                              child: Padding(
                                ...
                                child: Text(
                                  FFLocalizations.of(context).getText(
                                    'ipm0pk2t' /* Aqui estão os dados de acesso ... */,
                                  ),
                      ...
                      child: Column(
                        ...
                        children: [
                          Align(
                            ...
                            child: Text(
                              FFLocalizations.of(context).getText(
                                'y5tlib8i' /* COMO DESEJA RECEBER O CÓDIGO? */,
                              ),
                              textAlign: TextAlign.center,
                              style: FlutterFlowTheme.of(context)
                                  .bodyMedium
                          ...
                          Padding(
                            ...
                            child: FFButtonWidget(
                              onPressed: () async {
                                ...
                                _model.apiResultzp5 = await MainGroup
                                    .editProfileRequestCodeSmsCall
                                    .call(
                                  phone:
                                      '${FFAppState().phoneCountrySelected == null || FFAppState().phoneCountrySelected == '' ? '+1' : FFAppState().phoneCountrySelected}${_model.textController.text}',
                                  token: currentAuthenticationToken,
                                );

                                _shouldSetState = true;
                                if ((_model.apiResultzp5?.succeeded ?? true)) {
                                  context.goNamed(
                                    ConfirmPhoneWidget.routeName,
                                    queryParameters: {
                          ...
                          Padding(
                            ...
                            child: FFButtonWidget(
                              onPressed: () async {
                                var _shouldSetState = false;
                                _model.apiResultq6h = await MainGroup
                                ...
                                _shouldSetState = true;
                                if ((_model.apiResultq6h?.succeeded ?? true)) {
                                  context.goNamed(
                                    ConfirmPhoneWidget.routeName,
                                    queryParameters: {
                                      'messageSource': serializeParam(
