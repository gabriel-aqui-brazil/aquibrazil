            ...
            child: SingleChildScrollView(
              child: Column(
                ...
                children: [
                  Padding(
                    padding:
                        EdgeInsetsDirectional.fromSTEB(12.0, 24.0, 12.0, 5.0),
                    child: Container(
                      width: double.infinity,
                      height: 27.0,
                      decoration: BoxDecoration(),
                      ...
                      child: Row(
                        ...
                        children: [
                          RichText(
                            ...
                            text: TextSpan(
                              children: [
                                TextSpan(
                                  text: FFLocalizations.of(context).getText(
                                    'gcsw6it0' /* HISTÓRICO DE PAGAMENTOS */,
                                  ),
                                  style: FlutterFlowTheme.of(context)
                                      .bodyMedium
                                      .override(
                          ...
                          InkWell(
                            ...
                            onTap: () async {
                              context.pushNamed(
                                  HistoricoDePagamentoWidget.routeName);
                            },
                            child: RichText(
                              textScaler: MediaQuery.of(context).textScaler,
                              text: TextSpan(
                    ...
                    child: TextFormField(
                      ...
                      decoration: InputDecoration(
                        labelText: FFLocalizations.of(context).getText(
                          's3mwahi6' /* BUSCAR POR DATA, LOJA OU VALOR... */,
                        ),
                        labelStyle:
                                        ...
                                        Column(
                                          ...
                                          children: [
                                            ...
                                            Text(
                                              FFLocalizations.of(context)
                                                  .getText(
                                                'zl1rj7if' /* Agendamento n° 0926 - 04/11/20... */,
                                              ),
                                              style:
                                                  FlutterFlowTheme.of(context)
                                                      .bodyMedium
                                        ...
                                        Column(
                                          ...
                                          children: [
                                            ...
                                            Text(
                                              FFLocalizations.of(context)
                                                  .getText(
                                                '57j5jlgt' /* Agendamento n° 0926 - 04/11/20... */,
                                              ),
                                              style:
                                                  FlutterFlowTheme.of(context)
                                                      .bodyMedium
                                        ...
                                        Column(
                                          ...
                                          children: [
                                            ...
                                            Text(
                                              FFLocalizations.of(context)
                                                  .getText(
                                                'do8qgqra' /* Agendamento n° 0926 - 04/11/20... */,
                                              ),
                                              style:
                                                  FlutterFlowTheme.of(context)
                                                      .bodyMedium
