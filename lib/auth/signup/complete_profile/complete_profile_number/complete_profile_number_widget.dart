...
import 'complete_profile_number_model.dart';
export 'complete_profile_number_model.dart';

class CompleteProfileNumberWidget extends StatefulWidget {
  const CompleteProfileNumberWidget({super.key});

  static String routeName = 'completeProfileNumber';
  static String routePath = 'completeProfileNumber';

  @override
  State<CompleteProfileNumberWidget> createState() =>
      _CompleteProfileNumberWidgetState();
}

class _CompleteProfileNumberWidgetState
    extends State<CompleteProfileNumberWidget> {
  late CompleteProfileNumberModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => CompleteProfileNumberModel());
                      ...
                      Align(
                        ...
                        child: Text(
                          FFLocalizations.of(context).getText(
                            'q4l9icem' /* QUAL O SEU NÚMERO DE CELULAR? */,
                          ),
                          style:
                          ...
                          Column(
                            ...
                            children: [
                              ...
                              Align(
                                ...
                                child: Text(
                                  FFLocalizations.of(context).getText(
                                    'j05qgcik' /* NÓS ENVIAREMOS UM CÓDIGO PARA ... */,
                                  ),
                                  style: FlutterFlowTheme.of(context)
                                      .bodyMedium
                                      .override(
                          ...
                          Column(
                            ...
                            children: [
                              Align(
                                ...
                                child: Text(
                                  FFLocalizations.of(context).getText(
                                    'jmi11pp5' /* POR ONDE DESEJA RECEBER? */,
                                  ),
                                  style: FlutterFlowTheme.of(context)
                                      .bodyMedium
                                      .override(
                                      ...
                                      onPressed: () async {
                                        ...
                                        if (functions.lengthString(
                                          ...
                                          if ((_model.smsOutput?.succeeded ??
                                              true)) {
                                            context.pushNamed(
                                              CompleteProfileValidateNumberWidget
                                                  .routeName,
                                              queryParameters: {
