                                    ...
                                    child: Column(
                                      ...
                                      children: [
                                        Align(
                                          ...
                                          child: Text(
                                            FFLocalizations.of(context).getText(
                                              'ianor12j' /* FINALIZE SEU CADASTRO */,
                                            ),
                                        ...
                                        Align(
                                          ...
                                          child: Text(
                                            FFLocalizations.of(context).getText(
                                              'e19u2qw4' /* SUAS INFORMAÇÕES ESTÃO SEGURAS... */,
                                            ),
                                            style: FlutterFlowTheme.of(context)
                                                .bodyMedium
                                                .override(
                                      ...
                                      child: Column(
                                        ...
                                        children: [
                                          ...
                                          TextFormField(
                                            ...
                                            autofocus: false,
                                            readOnly: currentUserData?.email !=
                                                    null &&
                                                  ...
                                                  content: Text(
                                                    valueOrDefault<String>(
                                                      FFLocalizations.of(
                                                          ...
                                                          .getVariableText(
                                                        ptText:
                                                            'NÃO FOI POSSIVEL SALVAR SEUS DADOS, TENTE NOVAMENTE',
                                                        enText:
                                                            'UNABLE TO SAVE YOUR DATA, PLEASE TRY AGAIN',
                                                        esText:
                                                            'NO SE PUEDEN GUARDAR SUS DATOS, INTÉNTELO DE NUEVO',
                                                      ),
                                                      'NO SE PUEDEN GUARDAR SUS DATOS, INTÉNTELO DE NUEVO',
                                                    ),
                                                    style: TextStyle(
