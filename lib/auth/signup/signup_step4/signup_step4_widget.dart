...
import 'signup_step4_model.dart';
export 'signup_step4_model.dart';

class SignupStep4Widget extends StatefulWidget {
  const SignupStep4Widget({
    super.key,
  ...
  static String routeName = 'signup-step4';
  static String routePath = 'signupStep4';

  @override
  State<SignupStep4Widget> createState() => _SignupStep4WidgetState();
}

class _SignupStep4WidgetState extends State<SignupStep4Widget> {
  late SignupStep4Model _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => SignupStep4Model());
                            ...
                            Align(
                              ...
                              child: Text(
                                FFLocalizations.of(context).getText(
                                  'bshrbczl' /* ENVIAMOS O CÓDIGO PARA SEU CEL... */,
                                ),
                                          ...
                                          children: [
                                            TextSpan(
                                              text: FFLocalizations.of(context)
                                                  .getText(
                                                'kihk0rky' /* PARA REENVIAR O CÓDIGO, AGUARD... */,
                                              ),
