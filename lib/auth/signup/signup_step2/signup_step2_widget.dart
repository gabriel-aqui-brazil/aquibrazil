...
import 'signup_step2_model.dart';
export 'signup_step2_model.dart';

class SignupStep2Widget extends StatefulWidget {
  const SignupStep2Widget({super.key});

  static String routeName = 'signup-step2';
  static String routePath = 'signupStep2';
...
class _SignupStep2WidgetState extends State<SignupStep2Widget> {
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => SignupStep2Model());
                        ...
                        child: Column(
                          ...
                          children: [
                            Align(
                              ...
                              child: Text(
                                FFLocalizations.of(context).getText(
                                  'w5swc0x3' /* ENVIAMOS O CÓDIGO PARA SEU E-M... */,
                                ),
                            ...
                            Align(
                              ...
                              child: Text(
                                FFLocalizations.of(context).getText(
                                  '5xcczqzp' /* INSIRA O CÓDIGO DE SEGURANÇA Q... */,
                                ),
                                style: FlutterFlowTheme.of(context)
                                    .bodyMedium
                                    .override(
                          ...
                          Column(
                            ...
                            children: [
                                  ...
                                  child: Align(
                                    ...
                                    child: PinCodeTextField(
                                      ...
                                      onCompleted: (_) async {
                                        ...
                                        _model.validateEmail = await MainGroup
                                        ...
                                        if ((_model.validateEmail?.succeeded ??
                                            true)) {
                                          context.goNamed(
                                              SignupStep3Widget.routeName);
                                          ...
                                          children: [
                                            TextSpan(
                                              text: FFLocalizations.of(context)
                                                  .getText(
                                                'pi3tejaj' /* PARA REENVIAR O CÓDIGO, AGUARD... */,
                                              ),
                              ...
                              Align(
                                ...
                                child: Text(
                                  FFLocalizations.of(context).getText(
                                    'vafigqid' /* POR FAVOR, VERIFIQUE SUA CAIXA... */,
                                  ),
                                  style: FlutterFlowTheme.of(context)
                                      .bodyMedium
                                      .override(
