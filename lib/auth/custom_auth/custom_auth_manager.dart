...
class CustomAuthManager {
  ...
  Future signOut() async {
    ...
    aquiBrazilAuthUserSubject.add(
      AquiBrazilAuthUser(loggedIn: false),
    );
    persistAuthData();
  }

  Future<AquiBrazilAuthUser?> signIn({
    String? authenticationToken,
    String? refreshToken,
    DateTime? tokenExpiration,
    String? authUid,
  ...
  AquiBrazilAuthUser? _updateCurrentUser({
    String? authenticationToken,
    String? refreshToken,
    DateTime? tokenExpiration,
    String? authUid,
    ...
    final updatedUser = AquiBrazilAuthUser(
      loggedIn: true,
      uid: authUid,
      userData: userData,
    );
    aquiBrazilAuthUserSubject.add(updatedUser);
    persistAuthData();
    return updatedUser;
  }
...
AquiBrazilAuthUser? currentUser;
