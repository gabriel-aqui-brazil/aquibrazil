                      ...
                      child: RichText(
                        ...
                        text: TextSpan(
                          children: [
                            ...
                            TextSpan(
                              text: FFLocalizations.of(context).getText(
                                'yspc56if' /* EM PRODUTOS E SERVIÇOS. */,
                              ),
                              style: FlutterFlowTheme.of(context)
                                  .bodyMedium
                                  .override(
                      ...
                      child: RichText(
                        ...
                        text: TextSpan(
                          children: [
                            ...
                            TextSpan(
                              text: FFLocalizations.of(context).getText(
                                'g4zn4aq3' /* EM QUALQUER COMPRA NO APP. */,
                              ),
                              style: FlutterFlowTheme.of(context)
                                  .bodyMedium
                                  .override(
                      ...
                      child: RichText(
                        ...
                        text: TextSpan(
                          children: [
                            ...
                            TextSpan(
                              text: FFLocalizations.of(context).getText(
                                '43f7r6wp' /* EM NOSSA REDE DE PARCEIROS. */,
                              ),
                              style: FlutterFlowTheme.of(context)
                                  .bodyMedium
                                  .override(
