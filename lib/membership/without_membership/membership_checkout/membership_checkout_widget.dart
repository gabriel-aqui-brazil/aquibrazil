...
import 'membership_checkout_model.dart';
export 'membership_checkout_model.dart';

class MembershipCheckoutWidget extends StatefulWidget {
  const MembershipCheckoutWidget({
    super.key,
    this.couponCode,
    this.document,
  });
  ...
  static String routeName = 'membershipCheckout';
  static String routePath = 'membershipCheckout';

  @override
  State<MembershipCheckoutWidget> createState() =>
      _MembershipCheckoutWidgetState();
}

class _MembershipCheckoutWidgetState extends State<MembershipCheckoutWidget> {
  late MembershipCheckoutModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => MembershipCheckoutModel());
  }
  ...
  Widget build(BuildContext context) {
    ...
    return FutureBuilder<ApiCallResponse>(
      ...
      builder: (context, snapshot) {
        ...
        final membershipCheckoutMembershipCartReviewResponse = snapshot.data!;
                                            ...
                                            children: [
                                              TextSpan(
                                                text:
                                                    FFLocalizations.of(context)
                                                        .getText(
                                                  'hiuixk8y' /* A assinatura do AquiPASS  */,
                                                ),
                                                style: FlutterFlowTheme.of(
                                                        context)
                                                    .bodyMedium
                                              ...
                                              TextSpan(
                                                text:
                                                    FFLocalizations.of(context)
                                                        .getText(
                                                  'rb4i0y5e' /* Ela será renovada a cada ano n... */,
                                                ),
                                                style: GoogleFonts.inter(
                                                  fontSize: 12.0,
                                                ),
                                            ...
                                            children: [
                                              TextSpan(
                                                text:
                                                    FFLocalizations.of(context)
                                                        .getText(
                                                  '2klnkcuc' /* A assinatura do AquiPASS  */,
                                                ),
                                                style: FlutterFlowTheme.of(
                                                        context)
                                                    .bodyMedium
                                              ...
                                              TextSpan(
                                                text:
                                                    FFLocalizations.of(context)
                                                        .getText(
                                                  'nsdo98h8' /*  Ela será renovada a cada mês ... */,
                                                ),
                                                style: GoogleFonts.inter(
                                                  fontSize: 12.0,
                                                ),
                                            ...
                                            children: [
                                              TextSpan(
                                                text:
                                                    FFLocalizations.of(context)
                                                        .getText(
                                                  'ezcpifb9' /* Este plano possui pagamento ún... */,
                                                ),
                                                style: FlutterFlowTheme.of(
                                                        context)
                                                    .bodyMedium
                          ...
                          children: [
                            Padding(
                              ...
                              child: InkWell(
                                ...
                                onTap: () async {
                                  context.pushNamed(
                                      MembershipTermsWidget.routeName);
                                },
                                child: RichText(
                                  ...
                                  text: TextSpan(
                                    children: [
                                      TextSpan(
                                        text:
                                            FFLocalizations.of(context).getText(
                                          'duoyblun' /* Para saber mais, confira os  */,
                                        ),
                                        style: GoogleFonts.inter(
                                    ...
                                    if (widget!.document != null &&
                                      ...
                                      if ((_model.apiResultd7s?.succeeded ??
                                        ...
                                        await action_blocks.errorAlertSnacbar(
                                          context,
                                          textPt:
                                              'Ocorreu um erro ao salvar os seus dados!',
                                          textEs:
                                              '¡Se produjo un error al guardar sus datos!',
                                          textEn:
