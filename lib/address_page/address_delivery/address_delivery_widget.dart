...
import 'address_delivery_model.dart';
export 'address_delivery_model.dart';

class AddressDeliveryWidget extends StatefulWidget {
  const AddressDeliveryWidget({super.key});

  static String routeName = 'addressDelivery';
  static String routePath = 'addressDeliveryNew';
...
class _AddressDeliveryWidgetState extends State<AddressDeliveryWidget> {
  late AddressDeliveryModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => AddressDeliveryModel());
