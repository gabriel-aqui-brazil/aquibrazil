...
import 'order_rating_model.dart';
export 'order_rating_model.dart';
...
class _OrderRatingWidgetState extends State<OrderRatingWidget> {
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => OrderRatingModel());
            ...
            children: [
              ...
              if (false)
                Column(
                  ...
                  children: [
                    Text(
                      FFLocalizations.of(context).getText(
                        't7x94050' /* Do que mais você gostou? */,
                      ),
                      textAlign: TextAlign.center,
                      style: FlutterFlowTheme.of(context).bodyMedium.override(
                            font: GoogleFonts.poppins(
              ...
              Padding(
                ...
                child: FFButtonWidget(
                  onPressed: () async {
                    _model.apiResultt0b = await MainGroup.insertRatingCall.call(
                    ...
                    if ((_model.apiResultt0b?.succeeded ?? true)) {
                      Navigator.pop(context);
                    }
