                                  ...
                                  Column(
                                    ...
                                    children: [
                                      ...
                                      Padding(
                                        ...
                                        child: Text(
                                          FFLocalizations.of(context).getText(
                                            '0awadmzs' /* Entraremos em contao vai e-mai... */,
                                          ),
                                          textAlign: TextAlign.center,
                                          style: FlutterFlowTheme.of(context)
                                              .bodyMedium
                    ...
                    Padding(
                      ...
                      child: Column(
                        ...
                        children: [
                                        ...
                                        child: Padding(
                                          ...
                                          child: Container(
                                            ...
                                            child: OrderHelpWidget(
                                              order: FFAppState().orderSelected,
                                            ),
                                          ),
                                        ),
                                      ),
                          ...
                          if (FFAppState().orderSelected.status == 'Concluido')
                            Padding(
                              padding: EdgeInsetsDirectional.fromSTEB(
                                  12.0, 0.0, 12.0, 0.0),
                              child: Column(
